...
var responseViaResponseObject = async (res, outgoing) => {
  ...
  if (res.body) {
    try {
      if (resHeaderRecord["transfer-encoding"] || resHeaderRecord["content-encoding"] || resHeaderRecord["content-length"] || resHeaderRecord["x-accel-buffering"] && regBuffer.test(resHeaderRecord["x-accel-buffering"]) || !regContentType.test(resHeaderRecord["content-type"])) {
...
app.use("/static/htmx.1.9.10.min.js", serveStatic({ path: "./public/htmx.1.9.10.min.js" }));
app.get("/hello", (c) => {
  return c.text("Hello Hono!");
});
app.get("/", (c) => {
  return c.html(jsxDEV(layout_default, {
    children: jsxDEV("div", {
      class: "card max-w-[960px] mx-auto mt-3",
      children: jsxDEV("div", {
        style: "display:flex; flex-direction: column;",
        children: [
          jsxDEV("a", {
            href: "/clickme",
            children: "Click Me Demo"
          }, undefined, false, undefined, this),
          jsxDEV("a", {
            href: "/infinite-scroll",
            children: "Infinite Scroll Demo"
          }, undefined, false, undefined, this)
        ]
      }, undefined, true, undefined, this)
    }, undefined, false, undefined, this)
...
app.get("/clickme", (c) => c.html(jsxDEV(layout_default, {
  children: jsxDEV(clickme_default, {}, undefined, false, undefined, this)
}, undefined, false, undefined, this)));
var SomeJsxComponent = () => {
  return jsxDEV("div", {
    children: jsxDEV("h1", {
      children: "hi"
    }, undefined, false, undefined, this)
...
app.get("/infinite-scroll", (c) => {
  return c.html(jsxDEV(layout_default, {
    children: jsxDEV(SomeJsxComponent, {}, undefined, false, undefined, this)
  }, undefined, false, undefined, this));
});
app.post("/clicked", (c) => {
  return c.html(jsxDEV("h2", {
    children: "Clicked!"
  }, undefined, false, undefined, this));
});
var src_default = app;
